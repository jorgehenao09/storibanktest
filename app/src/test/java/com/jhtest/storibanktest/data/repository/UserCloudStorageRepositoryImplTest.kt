...
class UserCloudStorageRepositoryImplTest {
    ...
    @Test
    fun `saveUserData should call firebaseFirestoreDataSource with correct parameters`() =
        runTest {
            val signUpUserInfo =
                SignUpUserInfo(
                    userId = "12345",
    ...
    @Test
    fun `getUserData should emit success when firebaseFirestoreDataSource returns user data`() =
        runTest {
            val userId = "12345"
            val userData =
                UserData(
    ...
    @Test
    fun `getUserData should emit failure when firebaseFirestoreDataSource throws an exception`() =
        runTest {
            val userId = "12345"
