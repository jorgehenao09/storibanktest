...
class AuthenticationModule {
    ...
    @Provides
    @ViewModelScoped
    fun provideLoginRepository(firebaseAuthDataSource: FirebaseAuthDataSource): SignInRepository =
        SignInRepositoryImpl(firebaseAuthDataSource)

    @Provides
    @ViewModelScoped
    fun provideSignUpRepository(firebaseAuthDataSource: FirebaseAuthDataSource): SignUpRepository =
        SignUpRepositoryImpl(firebaseAuthDataSource)
