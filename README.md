# Stori Test
Stori Test is a basic Android app where a user can authenticate or create an user and see their latest movements in the bank. The newest changes will be on develop branch.
